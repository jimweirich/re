...
bq. _Regular Expressions are hard!  Let's go shopping._

p. Complex regular expressions are hard to construct and even harder
to read.  The Re library allows users to construct complex regular
...
p. Using the Re library, that regular expression can be built
incrementaly from smaller, easier to understand expressions.  Perhaps
something like this:
...
p. Although it is more code, the individual pieces are smaller and
...
This document describes Re version 0.0.5.1.
...
Issue Tracker :: http://www.pivotaltracker.com/projects/47758
Bug Reporting :: http://onestepback.org/cgi-bin/bugs.cgi?project=re
